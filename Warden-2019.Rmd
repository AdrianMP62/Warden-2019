...
```{r specify_season_for_Warden_only_ordination}
...
```{r aggregate_count_data_by_Common_name}
...
Warden.sum.m <- dcast(Wardensum..m, Survey ~ CommonName, fill="0")
...
```{r}
Warden.sum.pts <- as.data.frame(Warden.sum.MDS$points) #extract coordinates from ordination
