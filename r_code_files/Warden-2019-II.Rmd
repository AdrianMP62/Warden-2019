...
Warden.spr.dbrda <- capscale(Warden.spr.m ~ depth + CDM3MO_9542 + CDM6MO_9542, BEdat.spr.st, dist="bray")
Warden.spr.dbrda
plot(Warden.spr.dbrda)
Warden.sum.dbrda <- capscale(Warden.sum.m ~ depth + CDM3MO_9542 + CDM6MO_9542, BEdat.sum, dist="bray")
Warden.sum.dbrda
plot(Warden.sum.dbrda)
```
