...
```{r bio-env-Warden}
#SPRING
Warden.spr.be.P <- bioenv(Warden.spr.m, BEdat.spr, method = "pearson", index = "bray", metric="euclidean", partial = Pipeline.spr.m)
Warden.spr.be.P
...
#SUMMER
Warden.sum.be.P <- bioenv(Warden.sum.m, BEdat.sum, method = "pearson", index = "bray", metric="euclidean")
Warden.sum.be.P
...
#spring
BEdat.spr2 <- BEdat.spr #create new env dataset to include Pipeline_days
BEdat.spr2$Pipeline_days <- Pipeline.spr$Pipeline_days
Warden.spr.dbrda <- capscale(Warden.spr.m ~ . + Condition(Surv.Pipe.spr$Pipeline_days + Surv.Pipe.spr$Days), BEdat.spr, dist="bray") #Condition partials out Pipeline_days and Days
#plot(Warden.spr.dbrda, display = c("wa", "bp", "sp"))
Warden.spr.dbrda <-capscale(Warden.spr.m ~ CDM3MO_ESPER, BEdat.spr, dist="bray")
Warden.spr.dbrda
mod1 <- capscale(Warden.spr.m ~ CDM12MO_ESPER, BEdat.spr, dist="bray")
mod0 <- capscale(Warden.spr.m ~ 1, BEdat.spr, dist="bray")

mod1 <- capscale(Warden.spr.m ~ . + Condition(Surv.Pipe.spr$Pipeline_days + Surv.Pipe.spr$Days), BEdat.spr, dist="bray") #Condition partials out Pipeline_days
mod0 <- capscale(Warden.spr.m ~1, BEdat.spr, dist="bray")
Warden.spr.dbrda.step <- ordistep(mod0, scope = formula(mod1), perm.max = 999)
Warden.spr.dbrda.model <- capscale(Warden.spr.m ~ Depth + CDM12MO_ESPER + CDM12MO_EAERO + Condition(Surv.Pipe.spr$Pipeline_days + Surv.Pipe.spr$Days), BEdat.spr, dist="bray") 
Warden.spr.dbrda.model
#Condition partials out Pipeline_days
