...
add dummy variable to Pipeline_days
```
...
mod3 <- capscale(Warden.spr.m ~ CDM12MO_ESPER + Pipeline_days, BEdat.spr2, dist ="bray") #model selected by ordistep
...
```{r}
mean <- mean(Warden.spr.NoWa.md)
mean
write.csv(as.matrix(Warden.spr.NoWa.md), file = "Warden_spr_NoWa_md.csv") 
```
