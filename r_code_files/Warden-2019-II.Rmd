...
Warden.arrows.spr <-as.data.frame(fit$vectors$arrows*sqrt(fit$vectors$r))
Warden.arrows.spr$Species <- row.names(Warden.arrows.spr)



plot(Warden.spr.MDS, display="sites", type = "t", ylim= c(-5, 5), xlim=rev(c(-0.2, 0.2)))
plot(fit)
