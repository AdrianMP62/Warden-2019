...
Packages <- c("vegan", "ggrepel", "ggplot2", "stringr", "xlsx", "gsubfn", "reshape2", "knitr", "simba", "zoo", "car")
...
```{r}
rainfall <- read.csv("./raw_data/multi_station_cdm.csv")
```

```{r}
ggplot(rainfall, aes(x = Month, y = CDMM, colour=Station)) +
  geom_point()
```
