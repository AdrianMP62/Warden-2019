...
input.data <- read.csv("./raw_data/Warden_Gore_by_suite_06_19.csv")
  ...
  input.data$Survey <- gsub("Oct-2018", "Nov-2018", input.data$Survey) #lump survey dates that straddle Oct/Nov 2018
...
input.data.2 <- input.data[-grep("Unidentified", input.data$CommonName), ] #remove rows where birds not identified and save as a sep
#import taonomic nomenclature table
