...
Gore.sum.m[,1] <- NULL
write.csv(Gore.sum.m, "Gore_sum_m.csv")
...
```{r}
Gore.sum.MDS <- metaMDS(Gore.sum.m, distance = "bray", autotransform = FALSE, k=3)
Gore.spr.MDS <- metaMDS(Gore.spr.m, distance = "bray", autotransform = TRUE)
```
